...
class MainController extends AbstractController
{
     ...
     *
     * Accès réservé aux utilisateurs connectées (ROLE_USER°
     */
    ...
    public function editPhoto(Request $request, ManagerRegistry $doctrine, CacheManager $cacheManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // Récupération de l'emplacement ou on sauvegardera tous les photos de profil
            ...
            // Si l'utilisateur possède déjà une photo de profil et si cet photo existe dans le dossier, on la supprime
